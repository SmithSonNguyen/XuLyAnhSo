...
parser.add_argument(
    ...
    "-fd",
    type=str,
    default="./model/face_detection_yunet_2023mar.onnx",  # path mặc định truy cập
...
if __name__ == "__main__":
    ...
    dem = 111  # Khoi tao bien dem de luu ten file anh
    while True:
        ...
        if key == ord("s") or key == ord("S"):
            if faces[1] is not None:
                ...
                file_name = (
                    "./image/LeAnhTu/LeAnhTu%04d.bmp" % dem
                )  # Chinh sua ten file luu anh ở đây, mỗi người 1 thư mục riêng
